...
contract('TicTacToe', ([accounts,player1,player2]) => {
    ...
    // Tests For showing the flow of a game where finally player 1 wins

    describe('Any One Player Wins', async() => {
    ...
    // Tests For showing the flow of a game where there will be a draw i.e there will be no winner due to time out or many draws
    ...
    describe('Draw Game', async() => {
        ...
        // Tests for Sending money to both players as it is a draw game

        it('Sending money to both players as it is a draw game',async()=>{
            const result=await tictactoe.Draw(uniqueid);
        });
